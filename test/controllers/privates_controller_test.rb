...
class PrivatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create private" do
    assert_difference('Private.count') do
      post privates_url, params: { private: { : @private., Date: @private.Date, Title: @private.Title } }
    end
  ...
  test "should update private" do
    patch private_url(@private), params: { private: { : @private., Date: @private.Date, Title: @private.Title } }
